...
module LiterateX.Test.SourceFormat.LiterateHaskell (tests) where
...
run' = flip $ LiterateX.transformTextToText SourceFormat.LiterateHaskell
...
tests :: TestTree
tests = testGroup "LiterateHaskell"
    [ testStartShebangDoc
